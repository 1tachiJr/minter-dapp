...
const welcome_p = 'Spacesicle is a unique generative collection of AI-inspired texturized forms of the official Spacetry logo. Releasing on 4/20/22, The accompanying companion drop will be released on 4/27/22 and will feature an enlarged high definition rendering of the very designs used to create the actual Spacesicles. ';
...
const p_presale_coming_soon = "The Spacesicle invasion is almost here. Stay tuned for updates!";
...
const button_presale_coming_soon = "Check the discord for more information";
